...
public interface TestMapper {
	...
	public ScoreVO selectOne(int num); //3번 키값을 조회
	public HashMap<String, Object> selectTwo(int num); //3번 키값을 조회
	public ArrayList<HashMap<String, Object>> selectThree(); //map을 통한 다중값 전달
